...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        */
        ...
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); // input 231000, result: 231,000 
        }
    ...
    return {
        ...
        displayBudget: function (obj) {
            ...
            document.querySelector(DOMStrings.icomeLabel).textContent = formatNumber(obj.totalInc, 'inc');
